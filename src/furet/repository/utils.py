...
addSerializer(date, lambda v: v.strftime(DATE_FMT), lambda s, t: datetime.strptime(s, DATE_FMT).date())
addSerializer(bool, lambda v: serialize(int(v)), lambda s, t: bool(deserialize(s, int)))
